...
\           'canvas', 'caption', 'center', 'cite', 'code', 'col', 'colgroup', 'comment',
\           'datalist', 'dd', 'del', 'details', 'dfn', 'dialog', 'dir', 'div', 'dl', 'dt',
\           'em', 'embed', 'fieldset', 'figure', 'font', 'footer', 'form', 'frame', 'frameset',
...
\           'rp', 'rt', 'ruby',
\           's', 'samp', 'section', 'select', 'small', 'source', 'span', 'strike', 'strong', 'style',
\           'sub', 'summary', 'sup',
